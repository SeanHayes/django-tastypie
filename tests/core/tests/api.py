...
from core.tests.utils import adjust_schema
...
class ApiTestCase(TestCase):
    ...
    def test_urls(self):
        ...
        self.assertEqual([[pattern.name for pattern in include.url_patterns if hasattr(pattern, 'name')] for include in patterns if hasattr(include, 'reverse_dict')], [['api_dispatch_list', 'api_get_schema', 'api_get_multiple', 'api_dispatch_attribute', 'api_dispatch_detail'], ['api_dispatch_list', 'api_get_schema', 'api_get_multiple', 'api_dispatch_attribute', 'api_dispatch_detail']])
    ...
    def test_top_level_include_schema_content(self):
        ...
        notes_schema = adjust_schema(json.loads(note_resource.get_schema(dummy_request).content))
        user_schema  = adjust_schema(json.loads(user_resource.get_schema(dummy_request).content))
